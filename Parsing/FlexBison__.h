...
#define PROCESS_IDENT PROCESS_LEXEME(Ident, IDENT)
#define PROCESS_STR_LIT PROCESS_LEXEME(StrLit, STR_LIT)
#define PROCESS_INT_LIT PROCESS_LEXEME(NumLit, INT_LIT)
#define PROCESS_CHAR_LIT PROCESS_LEXEME(NumLit, CHAR_LIT)
#define PROCESS_FLOAT_LIT PROCESS_LEXEME(NumLit, FLOAT_LIT)
