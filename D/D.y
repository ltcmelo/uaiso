...
%token AUTO 357 "auto"
%token BEGIN_BUILTIN_TYPES 475 "$builtin_types_begin_marker$"
...
%token CHAR_UTF16 483 "char_utf16"
%token CHAR_UTF16_LITERAL 280 "<char_utf16_literal>"
%token CHAR_UTF32 484 "char_utf32"
...
%token COMPLEX_FLOAT32 480 "complex_float32"
%token COMPLEX_FLOAT64 479 "complex_float64"
%token COMPLEX_REAL 481 "complex_real"
...
%token END_BUILTIN_TYPES 505 "$builtin_types_end_marker$"
%token END_CHAR_LITERAL 282 "$char_literal_end_marker$"
%token END_COMMENT 272 "$comments_end_marker$"
%token END_KEYWORD 474 "$keyword_end_marker$"
...
%token EXPLICIT 383 "explicit"
%token EXPORT 384 "export"
%token EXTERN 385 "extern"
%token FALLTHROUGH 386 "fallthrough"
%token FALSE_LITERAL 294 "<false_literal>"
%token FINAL 387 "final"
%token FINALLY 388 "finally"
%token FLOAT32 486 "float32"
%token FLOAT64 485 "float64"
%token FLOAT_LITERAL 276 "<float_literal>"
%token FOR 389 "for"
%token FOREACH 390 "foreach"
%token FOREACH_REVERSE 391 "foreach_reverse"
%token FRIEND 392 "friend"
%token FROM 393 "from"
%token FUNC 394 "func"
%token FUNCTION 395 "function"
%token GLOBAL 396 "global"
%token GO 397 "go"
%token GOTO 398 "goto"
...
%token IF 399 "if"
%token IMAG_FLOAT32 488 "imaginary_float32"
%token IMAG_FLOAT64 487 "imaginary_float64"
%token IMAG_REAL 489 "imaginary_real"
%token IMMUTABLE 400 "immutable"
%token IMPORT 401 "import"
%token IN 402 "in"
%token INDENT 261 "<indent>"
%token INLINE 404 "inline"
%token INOUT 405 "inout"
%token INT 490 "int"
%token INT16 492 "int16"
%token INT32 493 "int32"
%token INT64 494 "int64"
%token INT8 491 "int8"
%token INTEGER_LITERAL 275 "<integer_literal>"
%token INTERFACE 406 "interface"
%token INVALID 260 "<invalid>"
%token INVARIANT 407 "invariant"
%token IN_LBRACE_HACK 403 "in_{_hack"
%token IS 408 "is"
%token LAMBDA 409 "lambda"
%token LAZY 410 "lazy"
...
%token MACRO 411 "macro"
%token MAP 412 "map"
%token MINUS_EQUAL 335 "-="
%token MINUS_MINUS 336 "--"
%token MIXIN 413 "mixin"
%token MODULE 414 "module"
%token MULTILINE_COMMENT 269 "<multiline_comment>"
%token MULTILINE_DOXY_COMMENT 270 "<multiline_doxy_comment>"
%token MUTABLE 415 "mutable"
%token NAMESPACE 416 "namespace"
%token NESTING_COMMENT 271 "<nesting_comment>"
%token NEW 417 "new"
%token NEWLINE 263 "<newline>"
%token NOEXCEPT 418 "noexcept"
%token NOGC 419 "nogc"
%token NONLOCAL 420 "nonlocal"
%token NOTHROW 421 "nothrow"
%token NOT_IN_HACK 422 "!_in_hack"
%token NOT_IS_HACK 423 "!_is_hack"
%token NULL_LITERAL 293 "<null_literal>"
%token OPERATOR 424 "operator"
%token OUT 425 "out"
%token OVERRIDE 426 "override"
%token PACKAGE 427 "package"
%token PASS 428 "pass"
...
%token PRAGMA 429 "pragma"
%token PRIVATE 430 "private"
%token PROPERTY 431 "property"
%token PROTECTED 432 "protected"
%token PUBLIC 433 "public"
%token PURE 434 "pure"
%token RANGE 435 "range"
...
%token REAL 495 "real"
%token REF 436 "ref"
%token REGISTER 437 "register"
%token REINTERPRET_CAST 438 "reinterpret_cast"
%token RETURN 439 "return"
%token RUNE 496 "rune"
%token SAFE 440 "safe"
%token SCOPE 441 "scope"
%token SELECT 442 "select"
%token SHARED 443 "shared"
%token SIZEOF 444 "sizeof"
...
%token STATIC 445 "static"
%token STATIC_ASSERT 446 "static_assert"
%token STATIC_CAST 447 "static_cast"
...
%token STRUCT 448 "struct"
%token SUPER 449 "super"
%token SWITCH 450 "switch"
%token SYNCHRONIZED 451 "synchronized"
%token SYSTEM 452 "system"
%token TEMPLATE 453 "template"
%token THIS 454 "this"
%token THREAD_LOCAL 455 "thread_local"
%token THROW 456 "throw"
%token TILDE_EQUAL 346 "~="
%token TRUE_LITERAL 295 "<true_literal>"
%token TRUSTED 457 "trusted"
%token TRY 458 "try"
%token TYPE 459 "type"
%token TYPEDEF 460 "typedef"
%token TYPEID 461 "typeid"
%token TYPENAME 462 "typename"
%token TYPEOF 463 "typeof"
%token UBYTE 497 "ubyte"
%token UCENT 498 "ucent"
%token UINT 499 "uint"
%token UINT16 501 "uint16"
%token UINT32 502 "uint32"
%token UINT64 503 "uint64"
%token UINT8 500 "uint8"
%token UNION 464 "union"
%token UNITTEST 465 "unittest"
%token USING 466 "using"
%token VAR 467 "var"
%token VERSION 468 "version"
%token VIRTUAL 469 "virtual"
%token VOID 504 "void"
%token VOLATILE 470 "volatile"
%token WHILE 472 "while"
%token WITH 473 "with"
%token YIELD 471 "yield"
%token __ATTRIBUTE__ 506 "__attribute__"
%token __DATE__MACRO 507 "__date__"
%token __EOF__MACRO 508 "__eof__"
%token __FILE__MACRO 509 "__file__"
%token __FUNCTION__MACRO 510 "__function__"
%token __GSHARED 511 "__gshared"
%token __LINE__MACRO 512 "__line__"
%token __MODULE__MACRO 513 "__module__"
%token __PARAMETERS 514 "__parameters"
%token __PRETTY_FUNCTION__MACRO 515 "__pretty_function__"
%token __THREAD 516 "__thread"
%token __TIMESTAMP__MACRO 518 "__timestamp__"
%token __TIME__MACRO 517 "__time__"
%token __TRAITS 519 "__traits"
%token __VECTOR 520 "__vector"
%token __VENDOR__MACRO 521 "__vendor__"
%token __VERSION__MACRO 522 "__version__"
    /*------------------------------------------*/
