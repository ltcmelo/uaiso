...
%token BEGIN_LIT 275 "$literal_begin_marker$"
%token BEGIN_MULTICHAR_OPRTR 299 "$multichar_operator_begin_marker$"
%token BEGIN_NUM_LIT 276 "$numeric_LIT_begin_marker$"
%token BEGIN_STR_LIT 285 "$STR_LIT_begin_marker$"
%token BODY 363 "body"
%token BOOL 499 "bool"
%token BREAK 364 "break"
%token BYTE 500 "byte"
%token CAPITAL_IDENT 266 "<capitalized_identifier>"
%token CAPITAL_IDENT_LIST 267 "<capitalized_identifier_list>"
...
%token CHAN 366 "chan"
%token CHAR 505 "char"
%token CHAR_LIT 281 "<char_literal>"
%token CHAR_UTF16 506 "char_utf16"
%token CHAR_UTF16_LIT 282 "<char_utf16_literal>"
%token CHAR_UTF32 507 "char_utf32"
%token CHAR_UTF32_LIT 283 "<char_utf32_literal>"
...
%token END_LIT 298 "$literal_end_marker$"
%token END_MULTICHAR_OPRTR 351 "$multichar_operator_end_marker$"
%token END_NUMERIC_LIT 279 "$numeric_LIT_end_marker$"
...
%token FLOAT_LIT 278 "<float_literal>"
%token FOR 398 "for"
...
%token INT_LIT 277 "<integer_literal>"
...
%token PURE 454 "pure"
%token QUALIFIED_OPRTR 301 "<qualified_OPRTR>"
%token RAISE 455 "raise"
%token RANGE 456 "range"
%token RAW_STR_LIT 290 "<raw_STR_literal>"
%token RAW_UTF16_STR_LIT 292 "<raw_utf16_STR_literal>"
%token RAW_UTF32_STR_LIT 293 "<raw_utf32_STR_literal>"
%token RAW_UTF8_STR_LIT 291 "<raw_utf8_STR_literal>"
%token REAL 518 "real"
%token REF 457 "ref"
...
%token STR_LIT 286 "<STR_literal>"
%token STR_UTF16_LIT 288 "<STR_utf16_literal>"
%token STR_UTF32_LIT 289 "<STR_utf32_literal>"
%token STR_UTF8_LIT 287 "<STR_utf8_literal>"
...
ImportItemDecl:
    NestedIdent
    {
        ...
        $$ = newAst<ImportItemDeclAst>()
            ->setActualName(newAst<NestedNameAst>()->setNamesSR($1));
    }
|   Ident '=' NestedIdent
    {
        DECL_1_LOC(@2);
        $$ = newAst<ImportItemDeclAst>()->setAlternateName($1)->setAsLoc(locA)
