...
void Binder::BinderTest::GoTestCase1()
{
    ...
    const Ident* runtime = lexs_.findAnyOf<Ident>("runtime");
    const Ident* ticks = lexs_.findAnyOf<Ident>("ticks");
    const Ident* lock = lexs_.findAnyOf<Ident>("lock");
    const Ident* val = lexs_.findAnyOf<Ident>("val");
    const Ident* tls0 = lexs_.findAnyOf<Ident>("tls0");
    const Ident* tickspersecond = lexs_.findAnyOf<Ident>("tickspersecond");
    const Ident* r = lexs_.findAnyOf<Ident>("r");
    const Ident* t0 = lexs_.findAnyOf<Ident>("t0");
    const Ident* c0 = lexs_.findAnyOf<Ident>("c0");
    const Ident* t1 = lexs_.findAnyOf<Ident>("t1");
    const Ident* c1 = lexs_.findAnyOf<Ident>("c1");
    const Ident* makeStringSlice = lexs_.findAnyOf<Ident>("makeStringSlice");
    const Ident* parforalloc = lexs_.findAnyOf<Ident>("parforalloc");
    const Ident* parfor = lexs_.findAnyOf<Ident>("parfor");
    const Ident* thr = lexs_.findAnyOf<Ident>("thr");
    const Ident* nthrmax = lexs_.findAnyOf<Ident>("nthrmax");
    const Ident* envs = lexs_.findAnyOf<Ident>("envs");
    const Ident* argslice = lexs_.findAnyOf<Ident>("argslice");
    const Ident* runtime_envs = lexs_.findAnyOf<Ident>("runtime_envs");
    const Ident* runtime_args = lexs_.findAnyOf<Ident>("runtime_args");
    const Ident* vertex = lexs_.findAnyOf<Ident>("vertex");
    const Ident* x = lexs_.findAnyOf<Ident>("x");
    const Ident* y = lexs_.findAnyOf<Ident>("y");
    const Ident* main = lexs_.findAnyOf<Ident>("main");
    const Ident* v = lexs_.findAnyOf<Ident>("v");
