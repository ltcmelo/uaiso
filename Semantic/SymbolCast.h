...
#define ConstAlias_Cast(T) static_cast<const uaiso::Alias*>(T)
#define Alias_Cast(T) static_cast<uaiso::Alias*>(T)
#define Alias_ConstCast(T) const_cast<uaiso::Alias*>(ConstAlias_Cast(T))

#define ConstBaseRecord_Cast(T) static_cast<const uaiso::BaseRecord*>(T)
...
#define ConstBlock_Cast(T) static_cast<const uaiso::Block*>(T)
...
#define ConstDeclSymbol_Cast(T) static_cast<const uaiso::Decl*>(T)
...
#define ConstValueDecl_Cast(T) static_cast<const uaiso::ValueDecl*>(T)
...
#define ConstVar_Cast(T) static_cast<const uaiso::Var*>(T)
